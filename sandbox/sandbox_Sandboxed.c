...
JNIEXPORT jint JNICALL Java_sandbox_Sandboxed_nativeThing
 ...
 */
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_nativeThingWithArgs
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_leakArray
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_arrayaccess
  (JNIEnv *env, jobject this, jintArray array)
{
	jboolean isCopy;
	assert(__builtin_memcap_sealed_get(array));
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_invalidarrayaccess
  (JNIEnv *env, jobject this, jintArray array)
{
	jboolean isCopy;
	assert(__builtin_memcap_sealed_get(array));
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_nativeTrap
  (JNIEnv *env, jobject this)
{
}

JNIEXPORT void JNICALL Java_sandbox_Sandboxed_reflectfields
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_reflectabuse
  (JNIEnv *env, jobject this, jobject r)
{
	jclass cls = (*env)->GetObjectClass(env, r);
	jfieldID f = (*env)->GetFieldID(env, cls, "x", "I");
...
JNIEXPORT void JNICALL Java_sandbox_Sandboxed_callbackintA
...
JNIEXPORT jint JNICALL Java_sandbox_Sandboxed_00024NativeState_count
  (JNIEnv *env, jobject this)
{
	static int x=1;
	return x++;
